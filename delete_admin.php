      ...
      <main class="page">
         <div class="_container">
            ...
            <div class="page__name">
               <h1 class=" page__name-text">Видалити адміністратора</h1>
            </div>

            <form action="delete_admin_handle.php" method="post" class="form__action">

               <input class="input_info" type="text" name="nick" placeholder="Введіть нікнейм чи e-mail"
                  value="<?php if (!empty($_SESSION['delete_nick'])) echo $_SESSION['delete_nick']; ?>">

               <input class="input_info" type="password" name="pwd" placeholder="Вкажіть ВАШ пароль">

               <button class="action" type="submit">Видалити</button>
